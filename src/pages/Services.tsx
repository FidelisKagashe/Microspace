    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-8 text-center">
          <h2 className="text-2xl font-bold text-blue-900 dark:text-blue-100 mb-4">Complete Product Catalog</h2>
        ...
        <div className="mt-16 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">Speak with our sales and support team</p>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">Quick chat for inquiries</p>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">Visit Store</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Explore products in person</p>
